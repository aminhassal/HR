    ...
    <div class="col-md-12">
        <div class="card">
           ...
           <input type="text"  name="fname" ><br>
            ...
            <div class="mb-3">
           <button  method="POST" type="submit" name="savecourses" class="btn btn-dark">إضافة</button>
            </div>
            </from>
            <div class="card-body">
                <table class="table table-bordered table-striped">
                    ...
                    <?php 
                            ...
                            $ClassID_FK =mysqli_real_escape_string($con, $_GET['CourseiID']);
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $student)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="class_view.php?course=<?= $student['CourseiID']; ?>" class="btn btn-info btn-sm">عرض</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
