    ...
    <div class="col-md-12">
        <div class="card">
           ...
           <input type="text"  name="fname" ><br>
            ...
            <div class="mb-3">
        <a href="Students_InsertToClass.php?ClassID=<?= $_GET['ClassID']; ?>" class="btn btn-dark float-end">إضافة طالب</a>
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $student)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="Course_view?course=<?= $student['CourseiID']; ?>" class="btn btn-info btn-sm">عرض</a>
                                        </td>
                                    </tr>
                                    <?php
                                }
